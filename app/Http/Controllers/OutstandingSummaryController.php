...
class OutstandingSummaryController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('report.outstanding.index',['customer'=>$customers,'invoice'=>$invoice]);
    }

    public function search(Request $request)
    {
        $query = CompleteOrder::with('customer', 'com_order_product','payment_details')->where('paid_status','=','0');
        ...
        $result->transform(function($res){
            ...
            //calc payment
            $paid_amt = 0;
            foreach ($res->payment_details AS $pay) {
        ...
        return view('report.outstanding.outstanding_body',['results'=>$result]);
    }
