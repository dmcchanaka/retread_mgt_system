            ...
            <table style="width: 100%; margin-bottom: 20px">
                <tbody>
                    <tr class="well" style="padding: 5px">
                        <th style="padding: 5px;text-align: center"><div> Invoice </div></th>
                    </tr>
                </tbody>
            </table>
            <div class="row">
                ...
                <div class="col-xs-5">
                    <table style="width: 100%">
                        <tbody>
                            <tr>
                                <th>Order No:</th>
                                <td class="text-right">{{$order->tyre_order->order_no}}</td>
                            </tr>
                            <tr>
                                <th>Invoice No:</th>
                                <td class="text-right">{{$order->com_order_no}}</td>
                            </tr>
                            <tr>
                                <th> Invoice Date: </th>
