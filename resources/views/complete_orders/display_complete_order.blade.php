                        ...
                        <table class="table table-striped jambo_table bulk_action">
                            <thead>
                                <tr class="headings">
                                    ...
                                    <th class="column-title" style="text-align: center">Serial Number </th>
                            ...
                            <tbody>
                                ...
                                foreach ($orderDetails as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left;padding-left: 3px">{{$data->serial_no}}</td>
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="6" style="text-align: right"><b>Gross Amount :</b></td>
                                    <td style="text-align: right;padding-right: 3px"><b>{{number_format($total_amt,2)}}</b></td>
                                </tr>
                                <tr>
                                    <td colspan="6" style="text-align: right"><b>Discount  {{$order->discount_per}} <?php if(isset($order->discount_per)){echo '%'; } ?> :</b></td>
                                    <td style="text-align: right;padding-right: 3px"><b>{{number_format($order->discount,2)}}</b></td>
                                </tr>
                                <tr>
                                    <td colspan="6" style="text-align: right"><b>Net Amount :</b></td>
