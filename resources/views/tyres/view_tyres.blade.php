...
//                                    dd($tt);
                                    ...
                                    <tr>
                                        <td>{{$tt->name}}</td>
                                        <td>{{$tt->size}}</td>
                                        <td>{{$tt->manufac_name}}</td>
                                        <td style="text-align: center"><?php if ($tt->tyre_status == 0) { ?><span style="color: green;"><?php echo $tyre_status; ?></span><?php }else{ ?><span style="color: red;"><?php echo $tyre_status; ?></span><?php }?></td>
                                        <td style="text-align: center;cursor: pointer">
                                            <?php if ($tt->tyre_status == 0) { ?>
