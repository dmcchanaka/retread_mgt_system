...
<div class="row">
    <div class="page-title">
            ...
            <div class="col-md-offset-5">
                <div class="input-group">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Outstanding Summary</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>OUTSTANDING INVOICE SUMMARY REPORT</h2>
                ...
                <div class="x_content">
                    ...
                    <div id="outstanding_details"></div>
...
<script>
    function search(){
        $.ajax({
            type: "GET",
            url: "/outstanding_summary/search",
            data: {
                'cus_id': $('#cus_id').val(),
            ...
            success: function (html) {
                $("#outstanding_details").html(html).show('slow');
            }
        });
    }
</script>
