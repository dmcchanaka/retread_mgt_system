                                    ...
                                    <tbody>
                                        <tr class="even pointer" id="tr_1">
                                            ...
                                            <td class=" ">
                                                ...
                                                <input type="hidden" style="text-align: right;padding-right: 5px" class="col-md-12" id="price_1" name="price_1" />
                                            </td>
                                            <td class=" "><input type="text" style="text-align: right;padding-right: 5px" class="col-md-12" id="serial_1" name="serial_1" /></td>
