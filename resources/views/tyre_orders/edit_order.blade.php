            ...
            <div class="x_panel">
                            ...
                            <table class="table table-striped jambo_table bulk_action" id="price_table">
                                <thead>
                                    <tr class="headings">
                                        ...
                                        <th class="column-title">Cus Price </th>
                                    ...
                                    foreach ($orderDetails AS $od) {
                                        ...
                                        <tr class="even pointer" id="tr_{{$count}}}">
                                            ...
                                            <td class=" ">
                                                ...
                                                <input type="hidden" style="text-align: right;padding-right: 5px" class="col-md-12" id="price_{{$count}}" name="price_{{$count}}" value="{{$od->price->cus_price}}" />
                                            </td>
                                            <td class=" "><input type="text" style="text-align: right;padding-right: 5px" class="col-md-12" id="serial_{{$count}}" name="serial_{{$count}}" value="{{$od->serial_no}}" /></td>
                ...
                <div class="form-group">
                    <div class="">
                        ...
                        <button type="button" id="add" class="btn btn-success" onclick="form_submit('add', 'order_form')">Submit</button>
                    </div>
                </div>
                </form>
            </div>
...
<script type="text/javascript">
                                            ...
                                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                                                    ...
                                                    var num = parseFloat($('#item_count').val()) + 1;
                                                            ...
                                                            + '<option>CUS PRICE</option>'
                                                            + '</select>'
                                                            + '<input type="hidden" style="text-align: right;padding-right: 5px" class="col-md-12" id="price_' + num + '" name="price_' + num + '" />'
                                                            + '</td>'
                                                            + '<td class=" "><input type="text" style="text-align: right;padding-right: 5px" class="col-md-12" id="serial_' + num + '" name="serial_' + num + '" /></td>'
                                                    ...
                                                    valid = false;
                                                            ...
                                                            $('#sub_cat_id_' + m).focus();
                                                            break;
                                                    } else if (document.getElementById('price_no_' + m) && ($('#price_' + m).val() == "")) {
                                                    valid = false;
