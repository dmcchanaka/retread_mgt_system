                        ...
                        <form class="form-horizontal form-label-left" action="{{url('update_parmission/'.$permissionGroup->pg_id)}}" method="post" name="permission_form" id="permission_form"">
                            ...
                            <div class="form-group">
                                <div class="">
                                    ...
                                    <button type="button" id="add" class="btn btn-success" onclick="form_submit('add', 'permission_form')">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script type="text/javascript">
    ...
    function handle_sub_Click(num,sub_num){
        var sub_check_status = document.getElementById("sub_ckbox_" + num + '_' + sub_num).checked;
        if ($('#per_group').val() === '' || parseFloat($('#per_group').val()) === 0) {
            alert('Please Enter Permission Group');
            document.getElementById("main_ckbox_" + num).checked = false;
            document.getElementById("main_status_" + num).value = 0;

            document.getElementById("sub_ckbox_" + num + '_' + sub_num).checked = false;
            document.getElementById("sub_status_" + num + '_' + sub_num).value = 0;
            $('#per_group').focus();
        } else if($('#user_type').val()=== '-1'){
            alert('Please Select User Type');
            document.getElementById("main_ckbox_" + num).checked = false;
            ...
            if (sub_check_status === true) {
                document.getElementById("main_status_" + num).value = 1;
                document.getElementById("main_ckbox_" + num).checked = true;

                document.getElementById("sub_ckbox_" + num + '_' + sub_num).checked = true;
                document.getElementById("sub_status_" + num + '_' + sub_num).value = 1;
                ...
                var count_new  = 0;
                for(var i = 1; i <= $('#sub_count_'+num).val(); i++){
                    if($('#sub_status_'+ num + '_' + i).val() == '1' && i != sub_num){
                        count_new++;
                    }
                } 
                if(count_new == 0){
